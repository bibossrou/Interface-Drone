...
if __name__ == "__main__":
    ...
    image_fleche_up = pygame.image.load('interface drone/fleche_up.png') 
    image_fleche_left = pygame.image.load('interface drone/fleche_left.png') 
    image_fleche_down = pygame.image.load('interface drone/fleche_down.png') 
    image_fleche_right = pygame.image.load('interface drone/fleche_right.png') 
    image_logo = pygame.image.load('interface drone/Logo_Scrypt_Carre_Blanc.png') 
